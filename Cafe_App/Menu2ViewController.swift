...
class Menu2ViewController: UIViewController, UITableViewDelegate, UITableViewDataSource {
    ...
    let names: Array<String> = [
        ...
        "망고요거트스무디",
        "딸기요거트스무"]
    let prices: Array<NSString> = ["HOT : 3,000\nICED : 3,500",
                                   "ICED : 3,500",
                                   "ICED : 3,500",
                                   "HOT : 3,000\nICED : 3,500",
                                   "HOT : 3,000\nICED : 3,000",
    ...
    let images: Array<String> = ["http://paikdabang.com/wp-content/uploads/2018/05/%EC%99%84%EC%A0%84%EC%B4%88%EC%BD%94.jpg",
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        cell.ItemImage.sd_setImage(with: URL(string: images[indexPath.row] as String))
    ...
    func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
        self.view.hideToast() //이전 토스트들과 겹치는것을 방지.
